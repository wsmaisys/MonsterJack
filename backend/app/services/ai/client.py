...
class AIClient:
    ...
    def _generate_fallback(self, messages: List[Dict[str, str]], format_json: bool) -> str:
        ...
        if format_json:
            return json.dumps({
                "title": "Unlocking High-Performance Content Workflows with Monster Jack",
                ...
                "instagram": "Work smarter, not harder on your content! 💡 Transform one great idea into a complete cross-platform campaign with Monster Jack.\n.\n.\n#marketing #contentcreator #digitalmarketing #productivity #growth",
